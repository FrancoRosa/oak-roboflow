...
def draw_predictions(frame, predictions, depth):
    for pred in predictions:
        ...
        cv2.rectangle(frame, top_left, (bottom_right[0], bottom_right[1] + base_line), (0, 255, 0), cv2.FILLED)
        cv2.putText(frame, label, (x - width // 2, y - height // 2), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1)
